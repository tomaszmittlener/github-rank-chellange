...
//Please read ../actions/README.md for more information.
...
const rootReducer = (state = defaultState, action) => {
  switch(action.type){
    ...
    case 'ADD_REPO_CONTRIBUTORS':
      ...
      const contributors = sortBy([ ..._contributorsUniques, ..._contributorsAddContributions ],
    ...
    case 'ADD_CONTRIBUTOR_INFO':
      const contributorsWithInfo = sortBy([ ...filter(state.contributors,
        contributorToRemove => contributorToRemove.login !== action.contributorWithInfo.login),
        action.contributorWithInfo ],
        'contributions').reverse();
